                ...
                <div class="tw-flow-root tw-mt-5 tw-border-b tw-border-gray-200">
                    <div class="tw-mx-4 tw--my-2-auto sm:tw--mx-5">
                        <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon3"><b>{{ $currency->code }}</b></span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('package_category_id',  $package_category,null, ['class' => 'form-control', 'required', 'placeholder' => __( 'messages.please_select' )]) !!}
                                </div>
                            </div>
                        ...
                        <div class="row text-center">
                            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg btn btn-primary">@lang('messages.save')</button>
                        </div>
