...
Route::middleware('web', 'auth', 'language', 'AdminSidebarMenu', 'superadmin')->prefix('superadmin')->group(function () {
    ...
    Route::resource('/packagescategories', 'Modules\Superadmin\Http\Controllers\PackagesCategoryController');
    ...
    Route::get('/get-package', [Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController::class, 'getPackageByCategory']);
});
...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->group(function () {
    ...
    Route::get('/subscription/{package_id}/register-pay', [Modules\Superadmin\Http\Controllers\SubscriptionController::class, 'addtrial'])->name('register-pay');
