        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($coupons)
                ...
                ->addColumn('action', function ($row) {
                    $html = '<a type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline btn btn-primary btn-xs " href="' . action([\Modules\Superadmin\Http\Controllers\CouponController::class, 'edit'], ['coupon' => $row->id]) . '">'
                ...
                class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-error btn btn-danger btn-xs delete_coupon_confirmation">' . __('messages.delete') . '</a>';
                    return $html;
                })
